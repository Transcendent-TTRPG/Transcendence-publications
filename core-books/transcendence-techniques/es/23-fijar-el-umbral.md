...
status: draft
canonical: false
tags: [techniques, agarre, reactive, utility, naghii, control, hold, pressure]
authority_refs:
...
*La salida existe hasta que una mano la convierte en frontera.*

| Rango | Área | Duración | Tirada |
| --- | --- | --- | --- |
| Cuerpo a Cuerpo | 1 Criatura | Instantáneo | T.E. (Agarre) |

| Salvación | Impacto | Ritmo | Desgaste |
| --- | --- | --- | --- |
| T.R. Alteraciones | - | `5` | `1` |
