---
title: "Lo Que Este Lugar Recuerda"
type: corebook
content_kind: rules
writing_mode: rules
language: es
...
status: draft
canonical: false
tags: [techniques, rastreo, specialization, utility, active, drakkai, environmental-memory, movement-history]
authority_refs:
...
*Lo que caminó aquí no se fue del todo.*

| Rango | Área | Duración | Tirada |
| --- | --- | --- | --- |
| Personal | Tú | Instantáneo | T.E. (Rastreo) |
...
- Competencia: `Rastreo` (Rango Novato o superior)
