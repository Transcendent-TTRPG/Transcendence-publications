...
status: draft
canonical: false
tags: [techniques, architecture, active, utility, naghii, targeting, setup, structural_analysis]
authority_refs:
...
*Todo cuerpo tiene un punto que no es grande, sino necesario.*
