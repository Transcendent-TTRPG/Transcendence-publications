...
status: draft
canonical: false
tags: [techniques, taumaturgia, utility, active, sauri, setup, information, handling]
authority_refs:
...
**Rango Novato**
*La secuencia no miente — el derrame llega siempre por el mismo paso.*

| Rango | Área | Duración | Tirada |
| --- | --- | --- | --- |
| 10m | 1 Superficie u Objeto | Permanente | T.E. (Taumaturgia) |
...
- Competencia: `Taumaturgia` (Rango Novato o superior)
