...
status: draft
canonical: false
tags: [techniques, bastion, utility, active, drakkai, stance, axis_control, mace]
authority_refs:
...
*No es una guardia. Es una razón por la que ese camino ya no existe.*

| Rango | Área | Duración | Tirada |
| --- | --- | --- | --- |
| Personal | Alcance del arma +1 | Permanente | — |

| Salvación | Impacto | Ritmo | Desgaste |
| --- | --- | --- | --- |
| T.R. (Alteraciones) | — | `3` | `2` |
