...
status: draft
canonical: false
tags: [techniques, aplomo, reactive, utility, sauri, counter_read, pressure, control]
authority_refs:
...
*El cuerpo puede estar roto — lo que no puede es mostrar exactamente cómo.*

| Rango | Área | Duración | Tirada |
| --- | --- | --- | --- |
| Personal | Tú | Instantáneo | `T.E. (Aplomo)` |
