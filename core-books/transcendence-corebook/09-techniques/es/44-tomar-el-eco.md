...
status: draft
canonical: false
tags: [techniques, resonancia, utility, active, sauri, information, detection, anti_concealment]
authority_refs:
...
**Rango Novato**
*Lo que tocó el lugar dejó un pulso — el origen ya se fue, pero el eco no.*
...
- Competencia: `Resonancia` (Rango Novato o superior)
