...
El Sistema de Tiradas define la mecánica de resolución para las acciones que los personajes intentan llevar a cabo, ya sea en combate, durante la exploración o en interacciones sociales. Su función es determinar el éxito o fracaso de una acción y, en ciertos casos, permitir el progreso de las competencias asociadas.

En términos generales, las tiradas utilizan un `d10` y se modifican con características, competencias, equipo y circunstancias. Los jugadores pueden decidir cómo afrontar ciertas acciones mediante la Ventaja Evolutiva, mientras que los NPCs y criaturas emplean un sistema simplificado acorde con su función narrativa.

Las competencias influyen directamente en varias tiradas del sistema. Por ello, primero se presentan aquí los tipos de tiradas y, más adelante, en la sección Competencias, se explica cómo se obtienen sus bonificadores y cómo progresan.
...
El jugador lanza dos dados y escoge el resultado mayor para resolver la acción. Al hacerlo, renuncia a cualquier posibilidad de aprendizaje derivada de esa tirada.

Esta opción representa un enfoque orientado exclusivamente al resultado: el personaje prioriza el éxito inmediato por encima del perfeccionamiento técnico.
...
Esta opción representa una ejecución más cuidadosa y reflexiva: el personaje asume un mayor riesgo de fallar a cambio de aprender de la experiencia.

## NPCs y otras criaturas

Los NPCs y monstruos no siguen necesariamente las mismas reglas de progresión que los personajes jugadores. En su lugar, cuentan con Rasgos, que representan ventajas, desventajas o capacidades especiales ligadas a su naturaleza, comportamiento, entorno, estado emocional o rol de combate.
...
En todos los casos, las competencias cumplen dos funciones:

- modifican tiradas
- permiten progresar a medida que el personaje las pone a prueba en situaciones relevantes

En el sistema, las competencias no sustituyen a las características: ambas se complementan. Las características expresan el potencial del personaje; las competencias expresan cuánto ha entrenado, practicado o refinado ese potencial.
...
- Alcanzar Experto reduce en una categoría la penalización a la velocidad de movimiento.
- Alcanzar Maestro reduce nuevamente esa penalización en una categoría.
...
- Cada rango de competencia otorga `+1` a las T.R de Aflicciones durante la meditación cognitiva.
...
Para evitar confusión, esta es la relación base entre ambos sistemas:

- T.A. usa la competencia del arma u objeto empleado.
- T.D. usa la competencia en Evasión.
- T.I. usa principalmente el rango de competencia del arma.
- T.C. no depende necesariamente de competencias, salvo que una regla específica lo indique.
- T.R. usa la resistencia correspondiente al tipo de efecto.
- T.E. usa la competencia de la especialización implicada.
- T.P. no usa competencias.
