...
Ninguna variante se elige. Ambas aparecen en todos los linajes sin patrón predecible. Un linaje de guardianes Kha puede producir un Saa cuya sola existencia altera la política local. Una familia de intérpretes Saa puede recibir un hijo Kha y leerlo como corrección, bendición, castigo o advertencia según la doctrina de su comunidad.
...
Los patrones culturales amplios — la arquitectura de zigurat, la jerarquía de sacerdotes-astrónomos, la veneración de los Primigenios, el control del archivo y la vigilancia del cielo — son lo suficientemente consistentes como para ser reconocibles entre comunidades. Los detalles de creencia, ritual y organización política varían de manera pronunciada.

La mayoría de las comunidades están gobernadas por una jerarquía teocrática de sacerdotes-astrónomos. Dentro de esa jerarquía, las dos variantes biológicas ocupan posiciones estructuralmente distintas, formalizadas a lo largo de generaciones en un arreglo de autoridad dual.

Los Kha-Naghii detentan la autoridad física: guardan las secciones más restringidas del archivo, controlan el acceso a la iniciación y actúan como brazo ejecutor de la orden sacerdotal cuando las decisiones deben hacerse cumplir. Los Saa-Naghii detentan la autoridad interpretativa: leen los registros astronómicos, interpretan eventos celestiales y asesoran a la orden sobre qué dice el cielo y qué debe hacerse.
...
Los textos originales — si pudieran leerse — podrían decir algo completamente diferente. La orden sacerdotal sabe esto en algún nivel. La mayoría elige no examinarlo directamente. El archivo es sagrado no porque sea ciertamente verdadero, sino porque abandonarlo significaría no tener nada.
...
Quién puede entrar a una cámara. Quién puede tocar una tablilla. Quién puede observar durante una noche marcada. Quién puede corregir una traducción antigua. Quién puede declarar que una lectura debe ser enterrada. En una comunidad Naghii, negar acceso puede ser más grave que dictar sentencia. Abrir una puerta puede ser más peligroso que iniciar una guerra.
