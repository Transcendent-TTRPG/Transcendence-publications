...
status: draft
canonical: false
tags: [limbo, tauma, vestigo, vínculo, flujo-ambiental, detección, manifestaciones, horror-cósmico]
related:
...
Un vínculo activo genera flujo ambiental en su entorno como efecto secundario. Su presencia en el mundo tiene peso ambiental aunque nadie lo esté usando.
...
**Taumaturgia** (Intelecto) es análisis estructurado. El personaje estudia la firma del Tauma: distingue vestigo de vínculo con certeza, identifica el sentido vinculado, puede clasificar aproximadamente el nivel de la entidad. Es la lectura más precisa disponible antes de la interacción directa.
