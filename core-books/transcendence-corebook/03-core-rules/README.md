...
Environmental Conditions moved to `13-gm-toolkit/` so the early rules chapter stays focused on the minimum player-facing rules needed before character creation.
