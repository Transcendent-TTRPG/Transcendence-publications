...
The Rolling System defines how the outcome of an action is determined, whether in combat, exploration, or social interaction. Checks use a `d10` modified by characteristics, competencies, equipment, and circumstances.
